...
CHECK (status IN ('pending', 'processing', 'completed', 'review_needed', 'failed', 'ready_to_process'));
...
CHECK (status IN ('extracted', 'review_needed', 'synced', 'failed', 'completed', 'reviewed'));

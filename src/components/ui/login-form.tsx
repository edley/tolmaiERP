...
export function LoginForm({
  ...
  return (
    <div className={cn("flex h-[700px] w-full", className)}>
      <div className="w-full hidden md:flex items-center justify-center bg-gradient-to-br from-indigo-500 to-indigo-700">
        <div className="text-center px-8">
          <h2 className="text-3xl font-bold text-white">Tolmai ERP</h2>
      ...
      <div className="w-full flex flex-col items-center justify-center p-8">
        ...
        >
          ...
          {onGoogleLogin && (
            <>
              <button
                ...
                className="w-full mt-6 bg-gray-500/10 flex items-center justify-center h-12 rounded-full gap-2 hover:bg-gray-500/15 transition-colors"
              >
          ...
          {emailError && <p className="w-full text-xs text-red-500 mt-1 pl-6">{emailError}</p>}
          ...
          {passwordError && <p className="w-full text-xs text-red-500 mt-1 pl-6">{passwordError}</p>}
          ...
          <div className="w-full flex items-center justify-between mt-6 text-gray-500">
            ...
            <a className="text-sm underline hover:text-indigo-500 transition-colors" href="#">
              Forgot password?
            </a>
          </div>
          ...
          <button
            type="submit"
            disabled={submitting}
            className="mt-6 w-full h-11 rounded-full text-white bg-indigo-500 hover:bg-indigo-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all font-medium"
          >
          ...
          {!isOnline && onDemoLogin && (
            <div className="w-full mt-6 space-y-3">
              ...
              <button
                type="button"
                onClick={onDemoLogin}
                className="w-full h-11 rounded-full text-white bg-gray-700 hover:bg-gray-800 transition-all font-medium text-sm"
              >
